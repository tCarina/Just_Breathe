        ...
        <div className="card-facts">
            ...
            <Card border="primary" style={{ width: "18rem" }}>
              ...
              <Card.Body>
                <Card.Text>
                  ...
                  men are twice as likely to be affected as men.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
            ...
            <Card border="primary" style={{ width: "18rem" }}>
              ...
              <Card.Body>
                <Card.Text>
                  ...
                  population, yet only 43.2% are receiving treatment.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          ...
          <div className="card7">
            <Card border="primary" style={{ width: "18rem" }}>
              ...
              <Card.Body>
                <Card.Text>
                  The WHO reports that anxiety disorders are the most common
                  mental disorders worldwide with specific phobia
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
